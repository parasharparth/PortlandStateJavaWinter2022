    ...
    public static void main(String[] args) throws IOException, ParserException {
        ...
        if (args.length == 12) {
            if (args[0].equals("-textFile") && args[1].contains(".txt")) {
                ...
                System.out.println(printer.getpretty((Flight) objs[1], a.getName() ));
                System.exit(0);
            }
        ...
        if(args.length == 14){
            if((args[0].equals("-textFile") && args[1].contains(".txt") && args[2].equals("-pretty") && args[3].equals("-"))
                ...
                for(Object f:parsedairline.getFlights()){
                    System.out.println(printer.getpretty((Flight) f, parsedairline.getName() ));
                }
                System.exit(0);
            }
